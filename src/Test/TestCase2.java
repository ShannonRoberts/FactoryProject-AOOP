...
public class TestCase2 extends javax.swing.JFrame {
     ...
     * Draw Drone on canvas. Shows how it will move and interact with JFrame.
     */
    static Lock masterLock =  new ReentrantLock();
    Graphics2D graphics;
    public TestCase2() {
        initComponents();
        graphics = (Graphics2D) canvas2.getGraphics();
        Drone drone = new Drone(canvas2, 273,22,graphics,masterLock);
